...
static
int
debugflagsparse (int nargs, char** args) {
  ...
  if (!strcmp(args[1],"1") && !strcmp(args[2], "on")) one = DB_LOCORE;
  else if (!strcmp(args[1],"2") && !strcmp(args[2], "on")) two = DB_SYSCALL;
  else if (!strcmp(args[1],"3") && !strcmp(args[2], "on")) three = DB_INTERRUPT;
  else if (!strcmp(args[1],"4") && !strcmp(args[2], "on")) four = DB_DEVICE;
  else if (!strcmp(args[1],"5") && !strcmp(args[2], "on")) five = DB_THREADS;
  else if (!strcmp(args[1],"6") && !strcmp(args[2], "on")) six = DB_VM;
  else if (!strcmp(args[1],"7") && !strcmp(args[2], "on")) seven = DB_EXEC;
  else if (!strcmp(args[1],"8") && !strcmp(args[2], "on")) eight = DB_VFS;
  else if (!strcmp(args[1],"9") && !strcmp(args[2], "on")) nine = DB_SFS;
  else if (!strcmp(args[1],"10") && !strcmp(args[2], "on")) ten = DB_NET;
  else if (!strcmp(args[1],"11") && !strcmp(args[2], "on")) eleven = DB_NETFS;
  else if (!strcmp(args[1],"12") && !strcmp(args[2], "on")) twelve = DB_KMALLOC;

  else if (!strcmp(args[1],"1") && !strcmp(args[2], "off")) one = 0;
  else if (!strcmp(args[1],"2") && !strcmp(args[2], "off")) two = 0;
  else if (!strcmp(args[1],"3") && !strcmp(args[2], "off")) three = 0;
  else if (!strcmp(args[1],"4") && !strcmp(args[2], "off")) four = 0;
  else if (!strcmp(args[1],"5") && !strcmp(args[2], "off")) five = 0;
  else if (!strcmp(args[1],"6") && !strcmp(args[2], "off")) six = 0;
  else if (!strcmp(args[1],"7") && !strcmp(args[2], "off")) seven = 0;
  else if (!strcmp(args[1],"8") && !strcmp(args[2], "off")) eight = 0;
  else if (!strcmp(args[1],"9") && !strcmp(args[2], "off")) nine = 0;
  else if (!strcmp(args[1],"10") && !strcmp(args[2], "off")) ten = 0;
  else if (!strcmp(args[1],"11") && !strcmp(args[2], "off")) eleven = 0;
  else if (!strcmp(args[1],"12") && !strcmp(args[2], "off")) twelve = 0;

  dbflags = one+two+three+four+five+six+seven+eight+nine+ten+eleven+twelve;
